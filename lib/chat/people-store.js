...
export function setCurrentOrgId(id) {
  _currentOrgId = id || null;
}

// True when a person exists but isn't part of the current org — i.e. an external
// contact. Returns false when we don't know the org yet, or for "me".
